...
for (const required of ['dist/cli.js', 'scripts/postinstall.mjs', 'apps/mac-voice/build.sh', 'apps/mac-voice/Resources/Info.plist', 'apps/mac-helper/build.sh', 'apps/mac-helper/Resources/AppIcon.png']) {
