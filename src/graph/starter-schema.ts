  ...
  levels: [
    ...
    },
    {
      ...
      axes: [
        ...
        { name: "name", type: "free" },
        { name: "role", type: "free", optional: true, description: "Role/title/relationship (DevOps Lead, mother, coach, captain…). Optional for casual contacts." },
        {
          name: "lead",
          type: "ref",
          refLevel: "unit",
          optional: true,
          description: "If this is a sub-group (department/team), the person who leads/represents it. Doesn't apply to unitKind=person.",
        },
      ],
    },
    {
